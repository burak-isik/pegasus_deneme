...
from ..helpers import get_subscription_urls, subscription_is_active
...
log = logging.getLogger("smart_review.subscription")
...
def _view_subscription(request, subscription_holder: SubscriptionModelBase):
    ...
    if not subscription.cancel_at_period_end:
        ...
        try:
            ...
            if (
                stripe_subscription
                and stripe_subscription.status != SubscriptionStatus.active
                or stripe_subscription.cancel_at_period_end
            ):
                log.warning(
