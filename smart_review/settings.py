"""
Django settings for Smart review project.
...
SECRET_KEY = env("SECRET_KEY", default="bMhOSQlIUPlkbClAYUUpvlPNhiQsSqGEXpcUTkuG")
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="smart_review"),
...
LANGUAGE_CODE = "en-us"
LANGUAGE_COOKIE_NAME = "smart_review_language"
...
if USE_S3_MEDIA:
    ...
    AWS_STORAGE_BUCKET_NAME = env("AWS_STORAGE_BUCKET_NAME", default="smart_review-media")
...
EMAIL_SUBJECT_PREFIX = "[Smart review] "

# Marketing email configuration

# set these values if you want to subscribe people to a mailing list when they sign up.
CONVERT_KIT_API_KEY = env("CONVERT_KIT_API_KEY", default="")
CONVERT_KIT_FORM_ID = env("CONVERT_KIT_FORM_ID", default="")
...
ASGI_APPLICATION = "smart_review.asgi.application"
CHANNEL_LAYERS = {
    "default": {
...
WAGTAIL_SITE_NAME = "Smart review Content"
...
LOGGING = {
    ...
    "loggers": {
        ...
        "smart_review": {
            "handlers": ["console"],
            "level": env("SMART_REVIEW_LOG_LEVEL", default="INFO"),
        },
    },
}
